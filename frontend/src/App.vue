    ...
    <div class="flex-1 bg-white rounded-t-3xl shadow-inner relative overflow-hidden">
      ...
      >
        ...
        >
          <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            <path
              d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 16.506c-1.487 1.487-3.399 2.494-5.894 2.494s-4.407-1.007-5.894-2.494S3.612 13.107 3.612 10.612s1.007-4.407 2.494-5.894S9.505 2.224 12 2.224s4.407 1.007 5.894 2.494 2.494 3.399 2.494 5.894-1.007 4.407-2.494 5.894zM12 4.8c-3.314 0-6 2.686-6 6s2.686 6 6 6 6-2.686 6-6-2.686-6-6-6zm0 9.6c-1.988 0-3.6-1.612-3.6-3.6S10.012 7.2 12 7.2s3.6 1.612 3.6 3.6-1.612 3.6-3.6 3.6z"
            />
          </svg>
          <span>Signal</span>
        </button>
